...
| Selfsimilarity_MHCI_conserved_binder        | score representing the similarity between `NetMHCpan_bestRank_peptide` and `NetMHCpan_bestRank_peptideWT` For conserved binder only                                                                                       |  self-similarity                    |
