...
| Pathogensimiliarity_MHCI_affinity_9mer    | score representing the   similarity of    `Best_affinity_MHCI_9mer_epitope` to pathogen sequences in IEDB   database                                                                                                                                                                                          | Recognition Potential           |
...
| IEDB_Immunogenicity_MHCI                  | IEDB Immunogenicity score                                                                                                                                                                                                                                                                                     | IEDB Immunogenicity             |
...
|hex_alignment_score                           |the alignment score by HEX                                                                                                                                                                                                                                                                                    |HEX                            |
