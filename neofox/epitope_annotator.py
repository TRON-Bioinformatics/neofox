...
from neofox.helpers import properties_manager
...
from neofox.new_features import differential_expression
from neofox.self_similarity import self_similarity
...
class EpitopeAnnotator:
    ...
    def __init__(self, provean_annotator, gtex, uniprot, aa_frequency, fourmer_frequency, aa_index,
        ...
        :type uniprot: neofox.uniprot.uniprot.Uniprot
        :type dissimilarity_calculator: neofox.predictors.dissimilarity_garnish.dissimilaritycalculator.DissimilarityCalculator
        :type neoantigen_fitness_calculator: neofox.predictors.neoantigen_fitness.neoantigen_fitness.NeoantigenFitnessCalculator
        :type neoag_calculator: neofox.predictors.neoag.neoag_gbm_model.NeoagCalculator
        :type predII: neofox.predictors.netmhcpan4.combine_netmhcIIpan_pred_multiple_binders.BestAndMultipleBinderMhcII
        :type predpresentation2: neofox.predictors.MixMHCpred.mixmhc2pred.MixMhc2Pred
        :type pred: neofox.predictors.netmhcpan4.combine_netmhcpan_pred_multiple_binders.BestAndMultipleBinderMhc
        :type predpresentation: neofox.predictors.MixMHCpred.mixmhcpred.MixMhcPred
        :type tcell_predictor: neofox.predictors.Tcell_predictor.tcellpredictor_wrapper.TcellPrediction
        :type iedb_immunogenicity: neofox.IEDB_Immunogenicity.predict_immunogenicity_simple.IEDBimmunogenicity
        :type differential_binding: neofox.literature_features.differential_binding.DifferentialBinding
        :type expression_calculator: neofox.literature_features.expression.Expression
        :type priority_score_calculator: neofox.literature_features.priority_score.PriorityScore
        :type available_alleles: neofox.helpers.available_alleles.AvailableAlleles
