...
def get_random_patient():
    ...
    patient.mhc_i_alleles = [
        MhcAllele(gene="A", group="01", protein="01"),
        MhcAllele(gene="B", group="01", protein="01"),
    ]
    patient.mhc_i_i_alleles = [
        MhcAllele(gene="DPA1", group="01", protein="01"),
        MhcAllele(gene="DPB1", group="01", protein="01"),
    ]
    patient.tissue = "skin"
    return patient
