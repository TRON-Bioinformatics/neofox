...
from neofox.model.neoantigen import Annotation, MhcOneMolecule
...
class BestAndMultipleBinder:
    ...
    def run(self, sequence_wt: str, sequence_mut: str, mhc_molecules: List[MhcOneMolecule], available_mhc_alleles: Set):
        """
        ...
        # print alleles
        np.mhc_prediction(mhc_molecules, available_mhc_alleles, tmp_fasta, tmp_prediction)
        ...
        best_epitopes_per_allele = mb.extract_best_epi_per_alelle(
            predicted_neoepitopes_transformed, NetMhcPanPredictor.get_alleles_netmhcpan_representation(mhc_molecules))
        # PHBR-I
