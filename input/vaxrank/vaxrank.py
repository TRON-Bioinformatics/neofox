...
class VaxRank():
    ...
    def total_binding(self, mut_scores):
        ...
        [mut_scores_logistic.append(self.logistic_epitope_score(ic50 = float(mhc_affinity))) for mhc_affinity in mut_scores_list]
    ...
    def main(self, epi_dict):
        mut_scores = epi_dict["MB_affinities"]
        self.expression_score = epi_dict["Expression_Mutated_Transcript"]
        self.total_binding_score = self.total_binding(mut_scores)
